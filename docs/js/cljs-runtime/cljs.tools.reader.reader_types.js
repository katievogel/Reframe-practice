...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41507 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41507(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41508 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41508(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41509 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41509(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41514 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41514(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41522 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41522(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41530 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41530(reader);
}
});
...
var G__41645 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41646 = s.append(c);
c = G__41645;
s = G__41646;
continue;
}
