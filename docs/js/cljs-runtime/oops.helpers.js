...
var G__42126 = cljs.core.next(items);
items = G__42126;
continue;
} else {
return arr;
...
var x42057 = error;
(x42057.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x42057.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__42142 = Object.getPrototypeOf(o);
o = G__42142;
continue;
} else {
...
var or__4120__auto__ = (cljs.core.truth_(wrap_QMARK_)?(function (){var temp__5739__auto__ = (goog.global["devtools"]);
