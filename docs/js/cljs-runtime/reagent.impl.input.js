...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__43127){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43128__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
}):(cljs.core.truth_((function (){var and__4109__auto__ = original_ref_fn;
if(cljs.core.truth_(and__4109__auto__)){
...
(jsprops.onChange = (function (p1__43137_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__43137_SHARP_);
}));
