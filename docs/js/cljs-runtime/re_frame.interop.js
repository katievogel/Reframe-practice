...
return [(function (){var pred__43269 = cljs.core.instance_QMARK_;
var expr__43270 = reactive_val;
if(cljs.core.truth_((pred__43269.cljs$core$IFn$_invoke$arity$2 ? pred__43269.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__43270) : pred__43269.call(null,reagent.ratom.RAtom,expr__43270)))){
return "ra";
} else {
if(cljs.core.truth_((pred__43269.cljs$core$IFn$_invoke$arity$2 ? pred__43269.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__43270) : pred__43269.call(null,reagent.ratom.RCursor,expr__43270)))){
return "rc";
} else {
if(cljs.core.truth_((pred__43269.cljs$core$IFn$_invoke$arity$2 ? pred__43269.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__43270) : pred__43269.call(null,reagent.ratom.Reaction,expr__43270)))){
return "rx";
} else {
if(cljs.core.truth_((pred__43269.cljs$core$IFn$_invoke$arity$2 ? pred__43269.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__43270) : pred__43269.call(null,reagent.ratom.Track,expr__43270)))){
return "tr";
} else {
return "other";
}
