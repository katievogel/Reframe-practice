...
var G__42282 = cljs.core.first(element_str);
switch (G__42282) {
case "?":
arr.push((1));
...
var G__42368 = cljs.core.next(items);
items = G__42368;
continue;
} else {
return null;
...
var G__42369 = cljs.core.next(items);
items = G__42369;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__42343 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__42343) : is_valid_QMARK_.call(null,G__42343));
})())){
var G__42371 = cljs.core.next(cljs.core.next(items));
items = G__42371;
continue;
} else {
return true;
...
switch (G__42356) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__42349_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42349_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__42351_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42351_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42356)].join('')));
