...
var G__43143 = o;
goog.object.set(G__43143,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43175__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__43175 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__43177__i = 0, G__43177__a = new Array(arguments.length -  0);
while (G__43177__i < G__43177__a.length) {G__43177__a[G__43177__i] = arguments[G__43177__i + 0]; ++G__43177__i;}
  args = new cljs.core.IndexedSeq(G__43177__a,0,null);
} 
return G__43175__delegate.call(this,args);};
G__43175.cljs$lang$maxFixedArity = 0;
G__43175.cljs$lang$applyTo = (function (arglist__43178){
var args = cljs.core.seq(arglist__43178);
return G__43175__delegate(args);
});
...
var G__43149 = o;
goog.object.set(G__43149,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43182__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__43185__i < G__43185__a.length) {G__43185__a[G__43185__i] = arguments[G__43185__i + 0]; ++G__43185__i;}
  args = new cljs.core.IndexedSeq(G__43185__a,0,null);
} 
return G__43182__delegate.call(this,args);};
G__43182.cljs$lang$maxFixedArity = 0;
G__43182.cljs$lang$applyTo = (function (arglist__43186){
var args = cljs.core.seq(arglist__43186);
return G__43182__delegate(args);
});
...
var G__43150 = props;
var G__43150__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43150,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43150);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43150__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4120__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43151 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43151,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43151;
}
})(),id_class);
...
var G__43152 = (cljs.core.count(argv) - first_child);
switch (G__43152) {
case (0):
...
var vec__43153 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43153,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43153,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43153,(2),null);
...
var temp__5739__auto___43194 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___43194 == null)){
} else {
var key_43195 = temp__5739__auto___43194;
(jsprops.key = key_43195);
}
...
var temp__5739__auto___43196 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___43196 == null)){
} else {
var key_43197 = temp__5739__auto___43196;
(jsprops.key = key_43197);
}
...
var temp__5739__auto___43198 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___43198 == null)){
} else {
var key_43199 = temp__5739__auto___43198;
(jsprops.key = key_43199);
}
...
var temp__5739__auto___43200 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___43200 == null)){
} else {
var key_43201 = temp__5739__auto___43200;
(jsprops.key = key_43201);
}
...
var jsprops = (function (){var or__4120__auto__ = props;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
return ({});
...
var temp__5739__auto___43204 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___43204 == null)){
} else {
var key_43205 = temp__5739__auto___43204;
(jsprops.key = key_43205);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43156_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43156_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43157 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43157,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43157,(1),null);
...
break;
default:
var G__43208 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43209 = compiler;
v = G__43208;
compiler = G__43209;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template43163 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template43163 = (function (opts,id,fn_to_element,meta43164){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta43164 = meta43164;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template43163.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43165,meta43164__$1){
var self__ = this;
var _43165__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43163(self__.opts,self__.id,self__.fn_to_element,meta43164__$1));
}));

(reagent.impl.template.t_reagent$impl$template43163.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43165){
var self__ = this;
var _43165__$1 = this;
return self__.meta43164;
}));

(reagent.impl.template.t_reagent$impl$template43163.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43163.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43163.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43163.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43163.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta43164","meta43164",1109493241,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43163.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43163.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43163");

(reagent.impl.template.t_reagent$impl$template43163.cljs$lang$ctorPrWriter = (function (this__4363__auto__,writer__4364__auto__,opt__4365__auto__){
return cljs.core._write(writer__4364__auto__,"reagent.impl.template/t_reagent$impl$template43163");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43163.
 */
reagent.impl.template.__GT_t_reagent$impl$template43163 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template43163(opts__$1,id__$1,fn_to_element__$1,meta43164){
return (new reagent.impl.template.t_reagent$impl$template43163(opts__$1,id__$1,fn_to_element__$1,meta43164));
});

}

return (new reagent.impl.template.t_reagent$impl$template43163(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
